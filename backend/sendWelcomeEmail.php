    ...
    if ($RecipientEmail) {
        ...
        if ($count > 0) {
            ...
            $htmlContent = "<h2> Hi, $prefix $RecipientName</h2>
                ...
                <p><a href='https://asfirj.org/verify?a=$encryptedButton'>click here</a> to verify your account.</p>
                <p>Or paste this <a href='https://asfirj.org/verify?a=$encryptedButton'>https://asfirj.org/verify?a=$encryptedButton</a> link in your browser</p>
